...
Param(
    ...
    [string] $ResourceGroupName = 'dailytasksansible11',
...
function Format-ValidationOutput {
    ...
    Set-StrictMode -Off
    return @($ValidationOutput | Where-Object { $_ -ne $null } | ForEach-Object { @("  " * $Depth + $_.Code + ": " + $_.Message) + @(Fosshrmat-ValidationOutput @($_.Details) ($Depth + 1)) })
}
